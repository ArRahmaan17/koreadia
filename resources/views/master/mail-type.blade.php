    ...
    <script>
        ...
        function actionData() {
            $('.edit').click(function() {
                ...
                if (window.type.rows('.selected').data().length == 0) {
                    $('#table-type tbody').find('tr').removeClass('selected');
                    $(this).parents('tr').addClass('selected')
                }

                var data = window.type.rows('.selected').data()[0];
        ...
        $(function() {
            window.type = $('#table-type').DataTable({
                scrollY: '100%',
            ...
            window.type.on('draw.dt', function() {
                actionData();
            });
