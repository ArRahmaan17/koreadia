        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-soft-success" id="save-priority">@lang('translation.save') Changes</button>
                    <button type="button" class="btn btn-soft-warning d-none" id="update-priority">@lang('translation.update') Changes</button>
                </div>
            </div>
        </div>
    </div>
