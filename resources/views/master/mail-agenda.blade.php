        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modal-agenda-label">@lang('translation.add') @lang('translation.mail_agenda')</h5>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-soft-success" id="save-agenda">@lang('translation.save') @lang('translation.changes')</button>
                    <button type="button" class="btn btn-soft-warning d-none" id="update-agenda">@lang('translation.update') @lang('translation.changes')</button>
                </div>
            </div>
        </div>
    </div>
