        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modal-role-user-label">@lang('translation.add') @lang('translation.role-user')</h5>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-soft-success" id="save-role-user">@lang('translation.save') @lang('translation.changes')</button>
                    <button type="button" class="btn btn-soft-warning d-none" id="update-role-user">@lang('translation.update') @lang('translation.changes')</button>
                </div>
            </div>
        </div>
    </div>
